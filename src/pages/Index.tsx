  ...
  return <div className="min-h-screen bg-gray-900 text-white overflow-x-hidden">
      ...
      <section className="relative pt-20 pb-16 px-4">
        <div className="container mx-auto text-center">
          <h1 className="font-extrabold text-4xl text-white mb-6 leading-tight tracking-tight px-0 mx-[240px] lg:text-6xl">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto text-center">
          <Link to="/home">
            <Button size="lg" className="bg-case-red hover:bg-red-600 text-white font-bold px-8 py-4 text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
